...
mongoose.connect('mongodb://localhost:27017/mernTodoDB', { useNewUrlParser: true });
...
var mernTodoDBSchm = mongoose.model('mernTodoDBSchm', todoSchema, 'todoCollection');

//exporting database
module.exports = { mernTodoDBSchm }
